      ...
      "lvimuser/lsp-inlayhints.nvim",
			{
				...
				cond = function()
					return require("barthap.utils").has("nvim-cmp")
				end,
			},
		},
		---@class PluginLspOpts
		opts = {
			...
			servers = {
				-- default servers. To install others, prefer doing it by adding langs explicitly
				-- to plugins/extra than here
				jsonls = {},
				lua_ls = {
        ...
        require("lsp-inlayhints").on_attach(client, buffer, false)
			...
			-- diagnostics
			for name, icon in pairs(require("barthap.config").icons.diagnostics) do
